window.onload = function()
{
	...
	setInterval(function()
	{
		...
		{
			img0.attr('src', 'http://localhost:8080/'+fotos[1]);
			img1.attr('src', 'http://localhost:8080/'+fotos[2]);
			img2.attr('src', 'http://localhost:8080/'+fotos[3]);
			img3.attr('src', 'http://localhost:8080/'+fotos[4]);
			img4.attr('src', 'http://localhost:8080/'+fotos[5]);
		}
		else if(cont == 7)
		{
			img0.attr('src', 'http://localhost:8080/'+fotos[6]);
			img1.attr('src', 'http://localhost:8080/'+fotos[7]);
			img2.attr('src', 'http://localhost:8080/'+fotos[8]);
			img3.attr('src', 'http://localhost:8080/'+fotos[9]);
			img4.attr('src', 'http://localhost:8080/'+fotos[10]);
		}
		else if(cont == 10)
		{
